  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="mt-10 shadow-2xl p-8 rounded-md">
        <p className="mt-4 text-white shadow-xl rounded-md bg-gradient-to-tr from-navpurp to-lightpurp p-2"> Username: {currUser.username} </p>
        <p className="mt-4 text-white shadow-xl rounded-md bg-gradient-to-tr from-navpurp to-lightpurp p-2"> Email: {currUser.email} </p>
        <p className="mt-4 text-white shadow-xl rounded-md bg-gradient-to-tr from-navpurp to-lightpurp p-2"> First Name: {currUser.first_name} </p>
        <p className="mt-4 text-white shadow-xl rounded-md bg-gradient-to-tr from-navpurp to-lightpurp p-2"> Last Name: {currUser.last_name} </p>
      </div>
      <button 
